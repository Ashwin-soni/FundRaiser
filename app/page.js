  ...
  return (
    <>
      ...
      <div className="text-white container mx-auto py-32">
        ...
        <div className="flex gap-5 justify-around">
          <div className="item space-y-3 flex flex-col items-center justify-center">
            ...
            <p className="text-center">Your Fans are available for ypu to help you</p>
          </div>
          <div className="item space-y-3 flex flex-col items-center justify-center">
      ...
      <div className="text-white container mx-auto py-32 flex flex-col items-center justify-center">
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/XW8e18ZX1bQ?si=HIykZuhJH6MRR8eV" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
      </div>
    </>
  );
}
